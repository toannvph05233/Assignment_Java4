...
<form method="post">
    <table class="col-12 table table-striped">
        ...
        <tr>
            <td>${requestScope["sanPham"].getIdSanPham()}</td>
            <td>${requestScope["sanPham"].getIdLoaiSanPham()}</td>
            <td>${requestScope["sanPham"].getNameSP()}</td>
            <td>${requestScope["sanPham"].getGiaSP()}</td>
            <td>${requestScope["sanPham"].getDateNhap()}</td>
            <td><img src='${requestScope["sanPham"].getImgSP()}' height="50" width="50"/></td>
