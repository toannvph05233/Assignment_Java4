    ...
    <form method="post">
        ...
        <table class="col-12 table table-striped">
            ...
            <tbody>
                ...
                <tr>
                    <td><input type="text" name="idSP" id="idSP" value='${requestScope["sanPham"].getIdSanPham()}'></td>
                    <td><input type="text" name="idLSP" id="idLSP" value='${requestScope["sanPham"].getIdLoaiSanPham()}'></td>
                    <td><input type="text" name="nameSP" id="nameSP" value='${requestScope["sanPham"].getNameSP()}'></td>
                    <td><input type="number" name="giaSP" id="giaSP" value='${requestScope["sanPham"].getGiaSP()}'></td>
                    <td><input type="text" name="imgSP" id="imgSP" value='${requestScope["sanPham"].getImgSP()}'></td>
