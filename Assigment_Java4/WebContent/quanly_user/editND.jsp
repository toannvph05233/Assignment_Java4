...
<form method="post">
    ...
    <table class="col-12 table table-striped">
        ...
        <tr>
            <td><input type="text" name="user"  value='${requestScope["nguoiDung"].getIdUser()}'></td>
            ...
            <td><input type="number" name="idloaiuser"  value='${requestScope["nguoiDung"].getIdLoaiAcout()}'></td>
